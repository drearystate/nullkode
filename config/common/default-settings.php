...
return [
    ...
    //branding
    ['name' => 'branding.site_name', 'value' => 'nullkode'],
    ...
    [
        ...
        'value' => json_encode(['Website Templates', 'Web App Templates', 'Landing Page', 'Blog', 'Portfolio', 'Business', 'Creative', 'Dashboard', 'SaaS', 'Admin Panel', 'E-commerce']),
    ],
    [
        'name' => 'builder.template_auth_standard',
        'value' => json_encode([
            'admin_password' => 'admin123!',
            'required_pages' => ['landing', 'login', 'register', 'forgot-password', 'dashboard'],
