...
import {ActionsPanel} from '@app/editor/editor-sidebar/actions-panel';
import {DataPanel} from '@app/editor/editor-sidebar/data-panel/data-panel';
  ...
  return (
    ...
    >
      ...
      <nav className="flex flex-shrink-0 flex-col items-center gap-8 border-r pt-8">
        ...
        <NavItemLayout icon={<TouchAppIcon />} panel={SidebarPanel.ACTIONS}>
          <Trans message="Actions" />
        </NavItemLayout>
        <NavItemLayout icon={<StorageIcon />} panel={SidebarPanel.DATA}>
          <Trans message="Data" />
        </NavItemLayout>
...
function SelectedPanel() {
  ...
  switch (activePanel) {
    ...
    case SidebarPanel.ACTIONS:
      return <ActionsPanel />;
    case SidebarPanel.DATA:
      return <DataPanel />;
