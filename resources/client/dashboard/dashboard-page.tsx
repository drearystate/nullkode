        ...
        <div className="container mx-auto flex-auto px-12">
          {usage?.projects.create.allowed === false && (
            <PolicyFailMessage
              ...
              resourceName={<Trans message="projects" />}
            />
          )}
          <div className="flex items-center gap-12 py-36">
            ...
            <TextField
              size="sm"
              placeholder={trans(message('Search projects...'))}
...
function NoProjectsMessage({isSearching}: NoProjectsMessageProps) {
  return (
    <IllustratedMessage
      className="mt-40"
      title={<Trans message="No projects" />}
      description={
        isSearching ? (
          <Trans message="No projects match your search query" />
        ) : (
          <Trans message="You have not created any projects yet" />
        )
      }
